...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "SELECT * FROM students WHERE student_number = '$student_number' AND password = '$password'";
...
<head>
    ...
    <title>Student Login - Student Accommodation</title>
...
<body class="bg-light d-flex flex-column min-vh-100">
    ...
    <div class="container mt-5 pt-5 flex-grow-1">
        <div class="bg-white p-5 rounded shadow" style="max-width: 500px; margin: auto;">
            <h2 class="text-primary mb-4"><i class="fas fa-sign-in-alt me-2"></i>Student Login</h2>
            <?php if (isset($error)): ?>
