...
$result = mysqli_query($con, "SELECT * FROM students WHERE id = " . $_SESSION['user_id']);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "UPDATE students SET name = '$name', surname = '$surname', email = '$email', phone = '$phone', gender = '$gender', date_of_birth = '$date_of_birth' WHERE id = " . $_SESSION['user_id'];
...
<head>
    ...
    <title>Profile - Student Accommodation</title>
...
<body class="bg-light d-flex flex-column min-vh-100">
    ...
    <div class="container mt-5 pt-5 flex-grow-1">
        <div class="bg-white p-5 rounded shadow" style="max-width: 600px; margin: auto;">
            <h2 class="text-primary mb-4"><i class="fas fa-user me-2"></i>Profile</h2>
            ...
            <form method="POST">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="surname" name="surname" value="<?php echo $student['surname']; ?>" required>
                    </div>
                </div>
                <div class="mb-3">
